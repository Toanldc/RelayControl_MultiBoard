/*
  ...
  - ESP32-C3 SuperMini GPIO 0..4 are used here (safe general-purpose pins,
    avoiding strapping pins 2/8/9 and the native-USB pins 18/19).
*/
...
const u8 RELAY_PINS[5] = {0, 1, 2, 3, 4}; // Relay 1..5
